...
class MethodChannelIMManager extends IMManager {
  ...
  MethodChannelIMManager(this._channel) {
    conversationManager = MethodChannelConversationManager(_channel);
    friendshipManager = MethodChannelFriendshipManager(_channel);
    messageManager = MethodChannelMessageManager(_channel);
    groupManager = MethodChannelGroupManager(_channel);
    userManager = MethodChannelUserManager(_channel);
